...
export default function DeviceRow({
  ...
  return (
    <div className={`${styles.card} ${open ? styles.cardOpen : ''}`}>
      {/* ── Main Row ── */}
      <div className={styles.mainRow} onClick={() => setOpen(!open)} role="button" tabIndex={0}
        ...
        {/* Coordinates — direct grid children for proper column alignment */}
      ...
      <Collapse in={open} timeout={300} unmountOnExit>
        <div className={styles.variablesPanel}>
          <div className={styles.variablesHeader}>
            ...
            <span className={styles.variablesCount}>{variables.length} channel{variables.length !== 1 ? 's' : ''}</span>
          </div>
